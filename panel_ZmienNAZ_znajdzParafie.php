...
<body >
	...
	<?php
		...
		$_SESSION["dekanatDoZnalezienia"]=$_GET["dekanatDoZnalezienia"];
		...
		echo 'Parafia: <select name="parafia" style="margin-left:12px; min-width:200px;" onchange="znajdzNAZ(this.value)">';
