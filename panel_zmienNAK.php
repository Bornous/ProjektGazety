			...
			*/
			...
			<div id="main" class="none_main">
					...
					<div style="min-height:10px; color:red; font-size:19px;text-align:center;"><?php if(isset($_GET['feedback']) AND isset($_GET["parafia"])){
							if($_GET['feedback']=="1"){
								echo "<div id='feedback' >Domyślny nakład został zmieniony pomyślnie.</div>";
								unset($_GET['feedback']);
								}
					...
					<form action="panel_ZmienNAK_send.php" method="get">
						Dekanat: <select name="dekanat" onchange="znajdzParafieNAK(this.value),wygaszenie()" style="min-width:200px;">
