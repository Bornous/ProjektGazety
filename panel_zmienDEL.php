	...
	<div id="contener">
			...
			*/
			...
			<div id="main" class="none_main">
					...
					<form action="panel_ZmienDEL_send.php" method="get">
						Dekanat: <select name="dekanat" onchange="znajdzParafieDEL(this.value),wygaszenie()" style="min-width:200px;">
					...
					<input type="submit" value="USUŃ PARAFIĘ"  class="option txtopt"  />
