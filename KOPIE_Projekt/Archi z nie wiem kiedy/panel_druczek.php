...
<head>
	...
	<script>
		function flink() {
		window.location.href = "panel_druczek.php";
		}
	</script>
...
<body>
	...
	<div id="contener">
		...
		<div id="main">
			...
			<span class="dane">Druczek: </span>
			
			
			<button class="option" onclick="flink()" style="min-width: 600px; margin-left: 70px;">Drukuj</button>
